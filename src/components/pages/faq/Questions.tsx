        ...
        <Grid
          ...
          <Accordion elevation={9}>
            <AccordionSummary
              ...
              id="panel3a-header"
            >
              <Typography variant="h6" px={2} py={1}>Why should I buy admin templates from Siyaratech Innovations?</Typography>
            </AccordionSummary>
            <Divider />
            <AccordionDetails>
              <Typography variant="subtitle1" pt={1} px={2} color="textSecondary">
                Adminmart offers high-quality templates that are easy to use and fully customizable.
                With over 101,801 happy customers & trusted by 10,000+ Companies. Siyaratech Innovations is
