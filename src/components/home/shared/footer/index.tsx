...
import IconFacebook from 'src/assets/images/home/icons/icon-facebook.svg';
import IconTwitter from 'src/assets/images/home/icons/icon-twitter.svg';
import IconInstagram from 'src/assets/images/home/icons/icon-instagram.svg';
...
const footerLinks = [
  {
    ...
    children: [
      ...
      },
      {
        title: false,
        titleText: 'Blog',
        link: 'https://modernize-react.adminmart.com/home/blog',
      },
    ],
  },
  {
      ...
      >
        <Stack direction="row" gap={1} alignItems="center">
          ...
          <Typography variant="body1" fontSize="15px">
            All rights reserved by Siyaratech Innovations.{' '}
          </Typography>
        </Stack>
        <Typography variant="body1" fontSize="15px">
          Produced by{' '}
          <Typography component={Link} color="primary.main" to="https://siyaratechin.com/">
