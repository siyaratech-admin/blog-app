...
const featuresData: FeaturesType[] = [
  ...
  },
  {
    ...
    subtext: 'Almost 45+ UI Components being given with Siyaratech Innovations Admin Pack.',
  },
  {
    icon: <IconPresentation width={40} height={40} strokeWidth={1.5} />,
    title: '4+ Frontend Pages',
    subtext: 'We have added useful frontend pages with Siyaratech Innovations Admin',
  },
  {
