...
const About = Loadable(lazy(() => import('../views/pages/home/About')));
const Contact = Loadable(lazy(() => import('../views/pages/home/Contact')));
const Portfolio = Loadable(lazy(() => import('../views/pages/home/Portfolio')));
const PagePricing = Loadable(lazy(() => import('../views/pages/home/Pricing')));
const BlogPage = Loadable(lazy(() => import('../views/pages/home/Blog')));
const BlogPost = Loadable(lazy(() => import('../views/pages/home/BlogPost')));
...
const Router = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', element: <Navigate to="/home/blog" /> },
      { path: '/dashboards/modern', exact: true, element: <ModernDash /> },
      { path: '/dashboards/ecommerce', exact: true, element: <EcommerceDash /> },
      { path: '/apps/contacts', element: <Contacts /> },
      // { path: '/apps/blog/posts', element: <Blog /> },
      // { path: '/home/blog/detail/:id', element: <BlogDetail /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/home/blog/detail/:id', element: <BlogPost /> },
      { path: '*', element: <Navigate to="/auth/404" /> },
    ],
  },
];
